export default function HeroSection() {
  return (
    <header className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
      {/* PERBAIKAN DI SINI: ganti 'flex-col-reverse' jadi 'flex-col' */}
      <div className="bg-white rounded-[2.5rem] p-6 md:p-12 shadow-card flex flex-col md:flex-row items-center gap-8 relative overflow-hidden">
        ...
        {/* Karena pakai flex-col (tanpa reverse), div Teks ini akan muncul DULUAN (di atas) */}
        <div className="w-full md:w-1/2 text-center md:text-left z-10">
          ...
          <p className="text-gray-500 mb-8 text-base leading-relaxed max-w-lg mx-auto md:mx-0">
            Tidak punya tim buat nanjak? Temukan barengan pendakian yang cocok atau gabung open trip terpercaya di sini.
          </p>
        </div>

        {/* Div Gambar ini akan muncul KEDUA (di bawah teks pada mobile, di kanan pada desktop) */}
